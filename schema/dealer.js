...
const Dealer = new Schema({
	...
	password: {
		...
		// match: [
		// 	/^(?=.[0-9])(?=.[!@#$%^&])[a-zA-Z0-9!@#$%^&]{6,16}$/,
		// 	"Password musth have at least one num,special and atleast 6 digits",
		// ],
	...
	mobile: Number,
	material: String,
	weight: { type: Number, min: [0, "Enter Valid Weight"] },
	quantity: { type: Number, min: [0, "Enter Valid quantity"] },
	state: String,
	city: String,
